    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray mt-2">Worgoo Akademi hesabınıza giriş yapın</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPw ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="w-full pl-10 pr-12 py-3 bg-bg border border-border rounded-xl text-sm text-foreground placeholder:text-gray-light focus:outline-none focus:border-purple focus:ring-1 focus:ring-purple/20" />
        ...
        <p className="text-center text-sm text-gray mt-6">
          Hesabınız yok mu?{" "}
          <Link href="/register" className="text-purple font-medium hover:underline">Kayıt Ol</Link>
        </p>
      </div>
    </div>
  );
