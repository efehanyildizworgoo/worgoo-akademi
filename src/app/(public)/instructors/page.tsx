  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-14">
        <h1 className="text-3xl md:text-4xl font-bold text-foreground">Eğitmenlerimiz</h1>
        <p className="text-sm text-gray mt-3 max-w-lg mx-auto">Alanında uzman profesyonellerden pratik odaklı eğitimler alın</p>
      </div>
