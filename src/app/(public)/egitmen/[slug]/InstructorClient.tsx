...
import { BookOpen, Users, Loader2, ArrowLeft, Globe, Linkedin, Twitter, Star, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function InstructorDetailPage() {
  ...
  useEffect(() => {
    fetch(`/api/public/instructors/${slug}`)
      .then((r) => r.json())
      .then((d) => {
  ...
  if (!instructor) return <div className="flex items-center justify-center min-h-[60vh]"><Loader2 size={28} className="animate-spin text-purple" /></div>;
