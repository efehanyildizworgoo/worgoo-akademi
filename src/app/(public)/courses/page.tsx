            ...
            <aside className="w-full lg:w-[280px] flex-shrink-0 space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-border/50 p-5">
                ...
                <div className="space-y-1">
                  <button
                    onClick={() => setCategory("")}
                    className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${!category ? "bg-purple/10 text-purple font-medium" : "text-gray hover:bg-bg hover:text-foreground"}`}
                  >
                    Tüm Kategoriler
                  </button>
                  {categories.map((c: any) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${category === c.slug ? "bg-purple/10 text-purple font-medium" : "text-gray hover:bg-bg hover:text-foreground"}`}
                    >
                      {c.name}
                    </button>
                  ))}
                ...
                <div className="bg-white rounded-2xl border border-border/50 p-5">
                  ...
                  <div ref={popularRef} className="flex gap-3 overflow-x-auto scrollbar-hide pb-1">
                    {popularCourses.map((c: any) => (
                      <Link key={c.id} href={`/courses/${c.slug}`} className="flex-shrink-0 w-[200px] group">
