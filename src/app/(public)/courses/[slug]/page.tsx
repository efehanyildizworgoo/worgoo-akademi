        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="lg:col-span-2">
              {course.category && (
                <Link href={`/courses?category=${course.category.slug}`} className="inline-block text-xs font-medium text-purple-300 bg-white/10 px-3 py-1 rounded-full mb-4 hover:bg-white/15 transition-colors">
            ...
            <div className="sticky top-24 bg-white border border-border rounded-2xl overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                ...
                {user ? (
                  ...
                  <Link href={`/login?redirect=/courses/${course.slug}`} className="flex items-center justify-center gap-2 w-full bg-purple text-white font-semibold py-3.5 rounded-xl hover:bg-purple-hover transition-colors text-sm">
